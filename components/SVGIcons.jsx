...
export const Transactions = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M2 7C2 6.44772 2.44772 6 3 6H13C13.5523 6 14 6.44772 14 7V9C14 9.55228 13.5523 10 13 10H3C2.44772 10 2 9.55228 2 9V7Z"
        fill="black"
      />
    </SvgIcon>
  )
...
export const Support = () => {
  return (
    ...
    >
      ...
      />
      <path
        d="M15.29 11.58V8.64001C14.7 9.60001 14.09 10.63 13.54 11.57H15.29V11.58Z"
        fill="#292D32"
      />
    </SvgIcon>
  )
...
export const Providers = () => {
  return (
    ...
    >
      <path
        d="M21.9201 16.75C21.5901 19.41 19.4101 21.59 16.7501 21.92C15.1401 22.12 13.6401 21.68 12.4701 20.82C11.8001 20.33 11.9601 19.29 12.7601 19.05C15.7701 18.14 18.1401 15.76 19.0601 12.75C19.3001 11.96 20.3401 11.8 20.8301 12.46C21.6801 13.64 22.1201 15.14 21.9201 16.75Z"
        fill="#292D32"
      />
      <path
...
export const Settlement = () => {
  return (
    ...
    >
      <path
        d="M11.94 2.20995L9.52995 7.81995H7.11995C6.71995 7.81995 6.32995 7.84995 5.94995 7.92995L6.94995 5.52995L6.98995 5.43995L7.04995 5.27995C7.07995 5.20995 7.09995 5.14995 7.12995 5.09995C8.28995 2.40995 9.58995 1.56995 11.94 2.20995Z"
        fill="#292D32"
      />
      <path
...
export const CircledUser = () => {
  return (
    ...
    >
      <circle cx="16" cy="16" r="15.5" stroke="url(#paint0_linear_5730_9837)" />
      <path
        d="M16 7.66669C13.8167 7.66669 12.0417 9.44169 12.0417 11.625C12.0417 13.7667 13.7167 15.5 15.9 15.575C15.9667 15.5667 16.0334 15.5667 16.0834 15.575C16.1 15.575 16.1084 15.575 16.125 15.575C16.1334 15.575 16.1334 15.575 16.1417 15.575C18.275 15.5 19.95 13.7667 19.9584 11.625C19.9584 9.44169 18.1834 7.66669 16 7.66669Z"
        fill="#191716"
      />
      <path
        d="M20.2334 17.7917C17.9084 16.2417 14.1167 16.2417 11.775 17.7917C10.7167 18.5 10.1334 19.4583 10.1334 20.4833C10.1334 21.5083 10.7167 22.4583 11.7667 23.1583C12.9334 23.9417 14.4667 24.3333 16 24.3333C17.5334 24.3333 19.0667 23.9417 20.2334 23.1583C21.2834 22.45 21.8667 21.5 21.8667 20.4667C21.8584 19.4417 21.2834 18.4917 20.2334 17.7917Z"
...
export const CategoriesSettings = () => {
  return (
    ...
    >
      ...
      <path
        d="M19.24 14H17.34C15.15 14 14 15.15 14 17.33V19.23C14 21.41 15.15 22.56 17.33 22.56H19.23C21.41 22.56 22.56 21.41 22.56 19.23V17.33C22.57 15.15 21.42 14 19.24 14Z"
        fill="#292D32"
      />
      <path
        d="M30.67 14H28.77C26.59 14 25.44 15.15 25.44 17.33V19.23C25.44 21.41 26.59 22.56 28.77 22.56H30.67C32.85 22.56 34 21.41 34 19.23V17.33C34 15.15 32.85 14 30.67 14Z"
        fill="#292D32"
      />
      <path
        d="M30.67 25.4297H28.77C26.59 25.4297 25.44 26.5797 25.44 28.7597V30.6597C25.44 32.8397 26.59 33.9897 28.77 33.9897H30.67C32.85 33.9897 34 32.8397 34 30.6597V28.7597C34 26.5797 32.85 25.4297 30.67 25.4297Z"
        fill="#292D32"
      />
      <path
        d="M19.24 25.4297H17.34C15.15 25.4297 14 26.5797 14 28.7597V30.6597C14 32.8497 15.15 33.9997 17.33 33.9997H19.23C21.41 33.9997 22.56 32.8497 22.56 30.6697V28.7697C22.57 26.5797 21.42 25.4297 19.24 25.4297Z"
        fill="#292D32"
      />
    </SvgIcon>
  )
