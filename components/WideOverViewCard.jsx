...
const WideOverViewCard = ({ label, amount, active, inactive }) => {
  return (
    <div tw="flex items-center justify-between bg-blue-light border border-border rounded-lg transition-colors p-4 pl-6 xl:(p-6 pl-8)">
      <div tw="w-1/3">
        <h1
      ...
      <div tw="w-2/3 max-w-[336px] bg-white flex px-6 py-7 rounded divide-x-2 divide-[#EBF2FA]">
