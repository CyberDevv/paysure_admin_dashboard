...
const GridWrapper = tw.div`mt-10`
...
const Form = tw.form`mt-11 flex items-end`
const Label = tw.label`text-[13px] text-[#454D54]`
const Input = tw.input`text-[13px] block border border-border mt-2 px-3.5 py-3 w-full rounded w-[336px] focus:(outline-none ring-2 ring-border2)`
const CheckboxWrapper = tw.div`flex items-center bg-[#FCEAE8] p-[3px] rounded ml-2.5 w-[254px]`
